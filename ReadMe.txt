...
LINK TO VIDEO...
hhttps://drive.google.com/file/d/1TXxgidIhJyGyV3Y_WgIg8RB7UGqZzEp8/view?usp=drive_link
...
#Instruction to run the project..
 ...
 to run this project go to folder named as "executable file" there is PhoneBook Application.exe file through which you can run the application.
 there is is also the the installation file in the "INSTALLATION" go and click the PhoneBook-Application.exe to run that application.
 you can check the source code in the folder "PhoneBook"